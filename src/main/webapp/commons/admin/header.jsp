    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown no-arrow">
            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                ...
                <c:if test="${sessionScope.account.images != null && sessionScope.account.images.startsWith('http')}">
                     <img class="img-profile rounded-circle" src="${sessionScope.account.images}" style="object-fit: cover;">
                </c:if>
