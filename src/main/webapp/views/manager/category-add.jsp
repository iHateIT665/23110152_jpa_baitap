...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        ...
        <form action="${pageContext.request.contextPath}/manager/category/insert" method="post" enctype="multipart/form-data">
            ...
            <a href="${pageContext.request.contextPath}/manager/category/list" class="btn btn-secondary btn-icon-split">
                <span class="icon text-white-50">
